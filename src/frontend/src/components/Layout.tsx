      ...
      >
        <div className="max-w-6xl mx-auto px-4 py-0">
          <div className="flex items-center justify-between h-16">
            <Link
              to="/"
              className="flex items-center gap-3 font-heading font-bold text-lg text-white"
              data-ocid="nav.link"
            >
              <img
            ...
            <nav className="hidden md:flex items-center gap-1">
              ...
              <button
                ...
                className="ml-2 px-4 py-2 rounded text-sm font-medium bg-white hover:bg-white/90 transition-colors disabled:opacity-50"
            ...
            <button
              type="button"
              className="md:hidden p-2 rounded text-white/80 hover:text-white"
            ...
            <nav className="md:hidden pb-3 flex flex-col gap-1">
              {navLinks.map((link) => (
                <Link
                  ...
                  data-ocid="nav.link"
                  className="px-3 py-2 rounded text-sm font-medium text-white/80 hover:bg-white/10 hover:text-white transition-colors"
                >
                  {link.label}
                </Link>
              ))}
              <button
                ...
                disabled={loginStatus === "logging-in"}
                data-ocid="nav.button"
                className="mt-1 px-3 py-2 rounded text-sm font-medium bg-white text-left disabled:opacity-50"
                style={{ color: "oklch(0.2 0.09 255)" }}
              >
                {loginStatus === "logging-in"
                  ? "Logging in..."
